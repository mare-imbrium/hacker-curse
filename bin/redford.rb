...
module HackerCurse
  ...
  class Redford
    def initialize app, options
      ...
      @fg = :white
      @_forumlist = %w{ news newest ruby programming scifi science haskell java scala cpp c_programming d_language golang vim emacs unix linux bash zsh commandline vimplugins python ars slashdot }
